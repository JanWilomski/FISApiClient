...
namespace Cross_FIS_API_1._2.Views
{
    ...
    public partial class InstrumentListWindow : Window
    {
        ...
        /// <summary>
        /// Obsługa podwójnego kliknięcia na wiersz w DataGrid
        /// Otwiera okno ze szczegółami wybranego instrumentu
        /// </summary>
        private void DataGrid_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            // Sprawdź czy kliknięto w wiersz (a nie w nagłówek lub pustą przestrzeń)
        ...
        {
            // Utwórz nowe okno ze szczegółami instrumentu
            var detailsWindow = new InstrumentDetailsWindow(instrument, _mdsService);
